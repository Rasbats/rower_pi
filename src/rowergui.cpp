...
rowerBase::rowerBase(wxWindow* parent, wxWindowID id, const wxString& title,
  ...
  m_buttonAuto->Connect(wxEVT_COMMAND_BUTTON_CLICKED,
                        wxCommandEventHandler(rowerBase::OnAuto), NULL, this);
  ...
  m_buttonWind->Connect(wxEVT_COMMAND_BUTTON_CLICKED,
                        wxCommandEventHandler(rowerBase::OnWind), NULL, this);
  m_buttonMinus1->Connect(wxEVT_COMMAND_BUTTON_CLICKED,
                          wxCommandEventHandler(rowerBase::OnMinus1), NULL,
                          this);
  m_buttonMinus10->Connect(wxEVT_COMMAND_BUTTON_CLICKED,
                           wxCommandEventHandler(rowerBase::OnMinus10), NULL,
                           this);
  m_buttonPlus10->Connect(wxEVT_COMMAND_BUTTON_CLICKED,
                          wxCommandEventHandler(rowerBase::OnPlus10), NULL,
                          this);
  m_buttonPlus1->Connect(wxEVT_COMMAND_BUTTON_CLICKED,
                         wxCommandEventHandler(rowerBase::OnPlus1), NULL, this);
  m_buttonSART->Connect(wxEVT_COMMAND_TOGGLEBUTTON_CLICKED,
                        wxCommandEventHandler(rowerBase::OnSART), NULL, this);
  m_buttonMOB->Connect(wxEVT_COMMAND_TOGGLEBUTTON_CLICKED,
                       wxCommandEventHandler(rowerBase::OnMOB), NULL, this);
  m_buttonEPIRB->Connect(wxEVT_COMMAND_TOGGLEBUTTON_CLICKED,
                         wxCommandEventHandler(rowerBase::OnEPIRB), NULL, this);
  m_buttonDistressAlert->Connect(
      wxEVT_COMMAND_TOGGLEBUTTON_CLICKED,
      wxCommandEventHandler(rowerBase::OnDistressAlert), NULL, this);
  m_buttonDistressCancel->Connect(
      wxEVT_COMMAND_TOGGLEBUTTON_CLICKED,
      wxCommandEventHandler(rowerBase::OnDistressCancel), NULL, this);
  m_buttonDistressRelay->Connect(
      wxEVT_COMMAND_TOGGLEBUTTON_CLICKED,
      wxCommandEventHandler(rowerBase::OnDistressRelay), NULL, this);
  m_buttonRelayCancel->Connect(wxEVT_COMMAND_TOGGLEBUTTON_CLICKED,
                               wxCommandEventHandler(rowerBase::OnRelayCancel),
                               NULL, this);
  m_buttonCollision->Connect(wxEVT_COMMAND_TOGGLEBUTTON_CLICKED,
                             wxCommandEventHandler(rowerBase::OnCollision),
                             NULL, this);
...
rowerBase::~rowerBase() {
  ...
  m_buttonRelayCancel->Disconnect(
      wxEVT_COMMAND_TOGGLEBUTTON_CLICKED,
      wxCommandEventHandler(rowerBase::OnRelayCancel), NULL, this);
  m_buttonCollision->Disconnect(wxEVT_COMMAND_TOGGLEBUTTON_CLICKED,
                                wxCommandEventHandler(rowerBase::OnCollision),
                                NULL, this);
